...
void main() {
    ...
    vec4 surf_color = vec4(0.1, 0.7, 0.1, 1.0);

    vec3 ambient = surf_color.rgb * ambient_light_pow;
    vec3 diffuse = surf_color.rgb * light_col;

    final_color = vec4(ambient + diffuse * light_v, surf_color.a);
